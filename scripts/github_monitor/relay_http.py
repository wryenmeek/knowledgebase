...
def main() -> None:
    ...
    # Use environment variable with safe local fallback, explicitly handling trimmed non-empty strings.
    parser.add_argument("--host", default=os.environ.get("HOST", "").strip() or "127.0.0.1")
