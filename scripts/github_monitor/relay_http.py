...
def main() -> None:
    ...
    # SECURITY: Bind to localhost by default instead of 0.0.0.0 to prevent unintended network exposure (Bandit B104)
    parser.add_argument(
        "--host", default=os.environ.get("HOST", "").strip() or "127.0.0.1"
    )
