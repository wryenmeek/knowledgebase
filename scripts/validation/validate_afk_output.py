...
def validate_afk_output(
    ...
    disallowed: list[str] = []
    # OPTIMIZATION: Use dict view set operations (keys() | keys()) instead of explicitly
    # instantiating sets (set(dict) | set(dict)) to avoid intermediate O(N) memory allocations.
