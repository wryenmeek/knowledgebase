...
def extract_headings(body: str) -> set[str]:
    ...
    # ⚡ Bolt: Using str.splitlines() is significantly faster in CPU execution time
    # than a manual find('\n') loop because it is highly optimized in C, and it
    # natively supports universal newlines (\r\n, \n, \r) without O(N) replacements.
