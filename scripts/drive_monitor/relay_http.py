...
def main() -> None:
    ...
    # SECURITY: Default to 127.0.0.1 instead of 0.0.0.0 to prevent unintended exposure of the server
    # to all network interfaces. Use an environment variable to allow override for containerized deployments.
