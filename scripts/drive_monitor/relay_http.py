...
def main() -> None:
    ...
    # Secure default (127.0.0.1) prevents unintended external network exposure (Bandit B104)
    # while allowing override via the HOST environment variable for containerized deployments.
