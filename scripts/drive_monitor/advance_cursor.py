...
def advance_cursor(
    *,
    ...
    -------
    SurfaceResult
        STATUS_PASS when all eligible cursors advance without error;
        STATUS_FAIL if any cursor update raises an ``OSError``.
    """
...
def run_cli(
    ...
    *,
    ...
    """Parse CLI arguments and run ``advance_cursor``.
