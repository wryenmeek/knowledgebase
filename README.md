...
| `python3 .github/skills/validate-wiki-governance/logic/validate_wiki_governance.py` | Run the fixed framework governance gate over qmd preflight, index, and authoritative commit-bound SourceRef linting. |
