...
| Pre-commit hooks | All hooks landed in `scripts/hooks/`: `check_frontmatter.py`, `check_hooks_json.py`, `check_no_staged_locks.py`, `check_sourceref_format.py`, `check_context_md_format.py`, `check_matrix_coverage.py`, `check_adr_cross_ref.py`, `check_stub_archive_path.py`. |
...
| Verification | 1169 tests green. Includes `tests/kb/test_github_customizations.py`, `test_framework_agents.py` (22 tests), `UsingAgentSkillsTests` class, and `tests/drive_monitor/` (11 test files). |
