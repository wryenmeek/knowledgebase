...
| [ADR-005](ADR-005-write-concurrency-guards.md) | Enforce write concurrency with workflow group and local file lock | Accepted — amended in-place; extended by ADR-031 |
...
| [ADR-019](ADR-019-fleet-jules-orchestration.md) | Jules-based fleet orchestration for parallel issue-to-PR dispatch | Accepted — amended in-place: Phase 3 merge trigger and security hardening; amended in-place: ops tooling safety contract; extended by Amendment 3 partial GitHub App token code path |
