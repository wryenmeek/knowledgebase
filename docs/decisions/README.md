...
| [ADR-004](ADR-004-split-ci-workflow-governance.md) | Split CI governance into gatekeeper, analyst, and PR-producing workflows | Accepted — extended by ADR-015 |
...
| [ADR-016](ADR-016-pre-commit-hooks-governance.md) | Use raw git hooks (not the pre-commit framework) for local governance checks | Accepted — amended in-place |
