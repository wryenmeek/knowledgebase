...
- `schema/`: page and ingest contracts.
...
4. Use canonical SourceRef citations: `repo://<owner>/<repo>/<path>@<git_sha>#<anchor>?sha256=<64-hex>`.
5. Keep wiki frontmatter aligned with `schema/page-template.md`.
