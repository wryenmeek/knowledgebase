...
## 2026-07-18 - [Insecure Default Bind Host]
**Vulnerability:** WSGI webhook receivers defaulted to binding to all interfaces (`0.0.0.0`), risking unintended external network exposure (Bandit B104).
**Learning:** Using `0.0.0.0` as a default bind address can inadvertently expose internal services if the environment is not perfectly firewalled.
