...
> Analyzed 1 issues on 2026-09-14T11:50:56.213Z
...
3. `InfigraphRuntime`: A class that:
   ...
   - Runs capability checks to distinguish between unavailable, unsupported, or ready to analyze.
   - Executes analysis commands with timeout handling and actionable failure reasons.
