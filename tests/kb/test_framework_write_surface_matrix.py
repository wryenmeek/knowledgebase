...
EXPECTED_WRITE_SURFACE_MATRIX_ROWS: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "scripts/fleet/fleet-dispatch.ts": {
        ...
        "Hard-fail behavior": ("missing/invalid planning artifact", "base-branch ≠ `main`", "soft-warn", "0/0/0 staged-diff", "fail closed"),
    },
    ...
    "scripts/fleet/fleet-merge.ts": {
        ...
        "Lock requirements": ("None within the repository",),
        "Artifact / schema owners": ("ADR-019", ".github/workflows/fleet-merge.yml", "scripts/fleet/github/pr-file-sanity.ts", "@google/jules-sdk"),
        "Hard-fail behavior": ("missing sessions.json", "merge conflict", "0/0/0 PR diff", "fail closed"),
    },
