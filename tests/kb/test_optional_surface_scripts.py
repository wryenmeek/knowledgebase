...
class OptionalSurfaceScriptTests(RuntimeWorkspaceTestCase):
    ...
    def test_quality_runtime_score_update_accepts_apply_alias(self) -> None:
        self.write_file(
            "wiki/high-priority-apply.md",
            '---\nconfidence: 2\nupdated_at: "2024-01-01T00:00:00Z"\n---\n\n# High Priority Apply\n\nTODO\n',
        )
        exit_code, payload = self._run_script(
            QUALITY_RUNTIME_PATH,
    ...
    def test_quality_runtime_rejects_apply_and_approval_combination(self) -> None:
        exit_code, payload = self._run_script(
            QUALITY_RUNTIME_PATH,
            "--mode",
            "score-update",
