...
# Run: bash .github/hooks/simplify-ignore-test.sh
...
eval "$(sed -n '/^filter_file()/,/^}/p' .github/hooks/simplify-ignore.sh)"
...
warning_out=$(echo 'NOT_JSON{{{' | bash .github/hooks/simplify-ignore.sh 2>&1) || true
