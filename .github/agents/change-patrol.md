...
This role does not invent a broad repo crawler, daemon, webhook mesh, or other surveillance runtime beyond the current MVP surfaces. It classifies and routes change risk; it does not bypass the evidence/policy sequence or perform ungated corrective writes.
